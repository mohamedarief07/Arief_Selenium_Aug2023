...
public class CreateLead extends ProjectSpecificMethod {
	...
	@Test(dataProvider="DynamicTestData01")
	public void createLeadTestCase01(String uName, String Pword,String cName,String fN, String lN,String localfn,String department,String description
			,String Email, String StateProvince) throws InterruptedException {
		...
		driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys(Email);
		 ...
		 driver.findElement(By.id("createLeadForm_generalStateProvinceGeoId")).sendKeys(StateProvince);

		/*
		 * WebElement elementStateProvince =
		 * driver.findElement(By.id("createLeadForm_generalStateProvinceGeoId")); Select
		 * dd = new Select(elementStateProvince); dd.selectByVisibleText("New York");
		 */
